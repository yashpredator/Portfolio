      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            I'm a full stack developer studying at the National Institute of Technology, Raipur. Passionate about technology from a young age, I excel in both front-end and back-end development, mastering languages and frameworks such as HTML, CSS, JavaScript, React, Node.js, and MongoDB. Notable projects during my time at NIT Raipur include dynamic websites and comprehensive web applications. Known for problem-solving skills and a collaborative spirit. With aspirations to innovate and address real-world challenges,  poised for a promising tech career.
            </p>
            {/* BIOGRAPHY QUOTE */}
